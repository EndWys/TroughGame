...
{
    public sealed class StandUpTransitionProcessor : BasePlayerMovementStateProcessor
    {
        ...
        {
            if (!input.IsCrouchPressed && State.PlayerPoseComponent.CanChangePose(PoseTypes.Stand))
            {
